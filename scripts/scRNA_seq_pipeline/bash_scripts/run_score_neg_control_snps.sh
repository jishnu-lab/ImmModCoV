...
#SBATCH -J Score_neg_control_snps
...
##Script
Rscript --no-save --no-restore --verbose /ix/djishnu/Priyamvada/RNA_seq_GWAS_integrated_analysis/R_scripts/Score_neg_control_snps.R $SNP_dir $SNP_dataset $SNP_dataset_name > /ix/djishnu/Priyamvada/RNA_seq_GWAS_integrated_analysis/test.Rout 2>&1
