...
SNP_file=SNP_dataset.bed #name of snp file
...
bedtools intersect -a $SNP_file -b $ref_abc_file -wa -wb > $Output_file_prefix.anno.abcroadmap.bed
##Overlap with 2kb file
bedtools intersect -a $SNP_file -b $ref_2kb_file -wa -wb > $Output_file_prefix.anno.2kb.bed
##Overlap with gene body file
bedtools intersect -a $SNP_file -b $ref_gene_body -wa -wb > $Output_file_prefix.anno.gene.body.bed
