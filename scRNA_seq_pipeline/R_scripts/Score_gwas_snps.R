...
output_file_name <- paste0(SNP_dataset_name, ".", "gws.snps.scored.txt")
snp_file_abc <-  read.table(paste0(SNP_dir,'/',SNP_dataset,'/',SNP_dataset_name, ".", "anno.abcroadmap.bed"))
snp_file_2kb <- read.table(paste0(SNP_dir,'/',SNP_dataset,'/',SNP_dataset_name, ".", "anno.2kb.bed"))
snp_file_gene_body <- read.table(paste0(SNP_dir,'/',SNP_dataset,'/',SNP_dataset_name, ".", "anno.gene.body.bed"))
